...
while i >= 0:
    ...
    elif line_new[i] in symbol1 and i <= len(line_new) - 3 and line_new[i + 1] in symbol1 and line_new[i + 2] in symbol1:lst.append(line_new[i])
    else:
        lst.append(' ')
    i -= 1
lst.reverse()
